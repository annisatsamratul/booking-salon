...
public class ReservationService {
    public static void createReservation(String customerId, String employeeId, List<Person> listPerson, List<Reservation> reservationList, String serviceId, List<Service> serviceList){
    	...
    	List<Service> serviceAdd = addService(serviceId, serviceList);
    	
    	Reservation reservations = new Reservation(generateReservationId(reservationList), customer, employee, serviceAdd, "In Process");
    ...
    public static List<Service> addService(String serviceId, List<Service> serviceList){
    	Service services = getServiceByServiceId(serviceId, serviceList);
    	List<Service> serviceAdd = new ArrayList<>();
    	serviceAdd.add(services);
    	return serviceAdd;
