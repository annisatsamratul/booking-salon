        ...
        do {
            ...
            switch (optionMainMenu) {
                ...
                case 2:
                	...
                	while(ispilih == true) {
                		serviceId = ValidationService.validateService(input, serviceId, serviceList);
                    	...
                    	ReservationService.createReservation(customerId, employeeId, listPerson, reservationList, serviceId, serviceList);
                	}
                	
                	
                	
                	System.out.print("Total Booking: Rp. ");
                	System.out.printf("%,.2f%n", ReservationService.getTotalBooking(reservationList));
                    break;
                case 3:
